...
const Home = () => {
  ...
  const forgotPassword = async () => {
    ...
    if (response.status === false) {
      toast.error("E-mail address not found");
    } else {
      ...
      <div>
        <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-900 h-screen">
          ...
          <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <h2
              className="mb-8 text-center text-3xl font-black tracking-tighter text-gray-200"
              style={{
              ...
              >
                {variant == "SIGNUP" && (
                  <Input
                    ...
                    classNames={{
                      ...
                      inputWrapper: ["bg-default-200/60"],
                    }}
                    type="text"
                    startContent={
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="relative text-sm font-semibold text-[#38bdf8] group no-underlineunderline"
                  >
                    <p className="relativ group-hover:no-underline">
                      Forgot password?
                      <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-[#38bdf8] transition-all duration-300 group-hover:w-full"></span>
                    </p>
                  </button>
